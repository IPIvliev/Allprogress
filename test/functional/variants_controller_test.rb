...
class VariantsControllerTest < ActionController::TestCase
  ...
  test "should create variant" do
    assert_difference('Variant.count') do
      post :create, variant: { articul: @variant.articul, company: @variant.company, description: @variant.description, picture: @variant.picture, price: @variant.price, status: @variant.status, url: @variant.url }
    end
  ...
  test "should update variant" do
    put :update, id: @variant, variant: { articul: @variant.articul, company: @variant.company, description: @variant.description, picture: @variant.picture, price: @variant.price, status: @variant.status, url: @variant.url }
    assert_redirected_to variant_path(assigns(:variant))
  end
